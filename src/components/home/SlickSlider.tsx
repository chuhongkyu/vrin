    ...
    return (
        ...
        <div className={styles["content-slider"]}>
            <Slider {...settings} ref={slickRef}>
                <div id="showroom" onClick={onClick}>
                    <div 
                ...
                <div id="exhibition" onClick={onClick}>
                    <div 
                        className={styles.card}
                ...
                <div id="product" onClick={onClick}>
                    <div 
                        className={styles.card}
            ...
            <div className={styles["arrow-content"]}>
                <div className={styles["prev"]} onClick={previous}>
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg"><circle opacity="0.8" cx="18" cy="18" r="18" fill="white"></circle><path d="M20.7 11.7002L14.4 18.0002L20.7 24.3002" stroke="#6F757B" strokeWidth="2" strokeLinecap="round"></path></svg>
                </div>
                <div className={styles["next"]} onClick={next}>
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg"><circle opacity="0.8" cx="18" cy="18" r="18" transform="matrix(-1 0 0 1 36 0)" fill="white"></circle><path d="M15.3 11.7002L21.6 18.0002L15.3 24.3002" stroke="#6F757B" strokeWidth="2" strokeLinecap="round"></path></svg>
                </div>
            </div>
            <div className={styles.dim}/>
        </div>
